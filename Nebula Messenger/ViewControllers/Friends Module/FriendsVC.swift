...
class FriendsVC: UIViewController, UIGestureRecognizerDelegate, CAAnimationDelegate {
...
// MARK: UINavigationControllerDelegate Ext.
extension FriendsVC: UINavigationControllerDelegate{
