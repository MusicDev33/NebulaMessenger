...
class EducationPoolView: UIView {
    ...
    let educationViewButton: UIButton = {
        let button = UIButton(type: .system)
    ...
    override init(frame: CGRect) {
        ...
        if admins.contains(GlobalUser.username){
            addSubview(normalViewButton)
            addSubview(educationViewButton)
        }
    ...
    func layoutSwapViews(){
        normalViewButton.widthAnchor.constraint(equalToConstant: 100).isActive = true
        normalViewButton.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -5).isActive = true
        normalViewButton.centerYAnchor.constraint(equalTo: self.backButton.centerYAnchor, constant: 0).isActive = true
        
        educationViewButton.widthAnchor.constraint(equalTo: normalViewButton.widthAnchor).isActive = true
        educationViewButton.centerXAnchor.constraint(equalTo: self.normalViewButton.centerXAnchor, constant: 0).isActive = true
        educationViewButton.topAnchor.constraint(equalTo: self.normalViewButton.bottomAnchor, constant: 10).isActive = true
    }
}
